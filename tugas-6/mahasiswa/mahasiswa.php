                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $data['alamat']; ?></td>
                      <td>
                        <a href="edit_mahasiswa.php?npm=<?=$data['npm']?>" class="btn btn-warning">Update</a>
                        <a href="delete_mahasiswa.php?npm=<?= $data['npm']?>" onclick="return confirm('yakin ingin dihapus?')" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
